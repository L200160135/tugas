...
<html lang="en">
  ...
  <head>
    ...
    <title>HOME | National Informatics Competition</title>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#masthead">Beranda</a>
            </li>
            <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#lomba" >Event</a>
            </li>
            <li class="nav-item">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="post" action="#">
            ...
            <div class="form-group" action="success.php">
              <button type="button" class="btn btn-primary btn-lg btn-block login-button">Register</button>

            </div>
            <div class="login-register">
                    <a href="http://localhost/tugasakhir/admin/login.php">Login</a>
                 </div>
          </form>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">Kategori Lomba</h2>
            <h3 class="section-subheading text-muted">Daftar kategori lomba NIC</h3>
          </div>
        </div>
              ...
              <li>
                ...
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    ...
                    <h4 class="subheading">Batas Pendaftaran</h4>
                  </div>
              ...
              <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    ...
                    <h4 class="subheading">Validasi Tim</h4>
                  </div>
                  <div class="timeline-body">
                    <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>
                  </div>
              ...
              <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    ...
                    <h4 class="subheading">Pengumuman Lolos Final</h4>
                  </div>
                  <div class="timeline-body">
                    <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>
                  </div>
        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="team-member">
              ...
              <h4>Alfi Dimar P</h4>
              <p class="text-muted">Database Enthusiast</p>
              <ul class="list-inline social-buttons">
                <li class="list-inline-item">
                  <a href="https://www.instagram.com/goinwild_/" target = "_blank">
          ...
          <div class="col-sm-4">
            <div class="team-member">
              ...
              <h4>Wahyu Dwi R</h4>
              <p class="text-muted">Design Frontend Enthusiast</p>
              <ul class="list-inline social-buttons">
                <li class="list-inline-item">
                  <a href="https://www.instagram.com/wahyuwir/" target = "_blank">
                    <i class="fab fa-instagram"></i>
                  </a>
                </li>
                <!-- <li class="list-inline-item">
          ...
          <div class="col-sm-4">
            <div class="team-member">
              ...
              <h4>Hamzah Miftakhuddin</h4>
              <p class="text-muted">Backend Enthusiast</p>
              <ul class="list-inline social-buttons">
                <li class="list-inline-item">
                  <a href="https://www.instagram.com/hamzahmifta/" target = "_blank">
                    <i class="fab fa-instagram"></i>
                  </a>
                </li>
                <!-- <li class="list-inline-item">
