<?php
  ...
  if(isset($_SESSION['admin'])) {
	...
	if (isset($_POST['simpan'])){
		...
		$sql = "INSERT INTO lomba(kategori, deskripsi, babak_penyisihan, penilaian) VALUES ('$kategori', '$deskripsi', '$bp', '$penilaian')";
            ...
            <div class="box-body">
			  ...
			  <form method="post" enctype="multipart/form-data">
				...
				<!-- input judul -->
    			  ...
    			  <div class="col-sm-10">
     				<input type="text" name="kategori" class="form-control" id="inputEmail3" placeholder="Kategori Lomba">
    			  </div>
  				</div>            
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<textarea name="babak_penyisihan" class="form-control" id="exampleFormControlTextarea1" rows="10"></textarea>
					</div>
  				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<textarea name="penilaian" class="form-control" id="exampleFormControlTextarea1" rows="10"></textarea>
					</div>
  				</div>
