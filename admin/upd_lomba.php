<?php
  ...
  if(isset($_SESSION['admin'])) {
    ...
    $get_id     = $_GET['id'];
    $sql_view   = "SELECT * FROM lomba WHERE id_lomba = $get_id";
	...
	if (isset($_POST['simpan'])){
		...
		$bp	        = $_POST['babak_penyisihan'];
		$penilaian 	= $_POST['penilaian'];

		// insert ke database tabel lomba
		$sql = " UPDATE lomba SET kategori='$kategori', deskripsi='$deskripsi', babak_penyisihan='$bp', penilaian='$penilaian' WHERE id_lomba = $get_id";
        ...
        <section class="content">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"> Tambah lomba</h3>
            ...
            <div class="box-body">
			  ...
			  <form method="post" enctype="multipart/form-data">
				...
				<!-- input judul -->
    		      ...
    		      <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Lomba</label>
    			  <div class="col-sm-10">
     				<input type="text" name="kategori" class="form-control" id="inputEmail3" placeholder="Kategori Lomba" value="<?= $data['kategori'] ?>">
    			  </div>
  				</div>            
				
				<!-- input Deskripsi -->
				<div class="form-group row">
					<label for="exampleFormControlTextarea1" class="col-sm-2 col-form-label">Deskripsi Lomba</label>
					<div class="col-sm-10">
						<textarea name="deskripsi" class="form-control" id="exampleFormControlTextarea1" rows="10"><?= $data['deskripsi'] ?></textarea>
					</div>
  				</div>

				<!-- input Babak Penyisihan -->
				<div class="form-group row">
					<label for="exampleFormControlTextarea1" class="col-sm-2 col-form-label">Babak Penyisihan</label>
					<div class="col-sm-10">
						<textarea name="babak_penyisihan" class="form-control" id="exampleFormControlTextarea1" rows="10"><?= $data['babak_penyisihan'] ?></textarea>
					</div>
  				</div>

                <!-- input Penilaian -->
				<div class="form-group row">
					<label for="exampleFormControlTextarea1" class="col-sm-2 col-form-label">Penilaian Lomba</label>
					<div class="col-sm-10">
						<textarea name="penilaian" class="form-control" id="exampleFormControlTextarea1" rows="10"><?= $data['penilaian'] ?></textarea>
					</div>
  				</div>
