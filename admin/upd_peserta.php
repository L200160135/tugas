<?php
  ...
  if(isset($_SESSION['admin'])) {
    ...
    $get_id     = $_GET['id'];
    $sql_pes    = "SELECT * FROM peserta WHERE id_peserta='$get_id'";
    $result_pes = mysqli_query($conn, $sql_pes);
    $data_pes   = mysqli_fetch_array($result_pes);
	...
	if (isset($_POST['update'])){
		...
		$sql = "UPDATE peserta SET nama_peserta='$nama', tempat_lahir='$tempat_lahir', tgl_lahir='$tgl_lahir', jenis_kelamin='$jenis_kelamin', alamat='$alamat', email='$email', instansi='$instansi', id_tim='$tim' WHERE id_peserta=$get_id";
            ...
            <div class="box-body">
			  ...
			  <form method="post" enctype="multipart/form-data">
				<!-- input nama -->
    			  ...
    			  <div class="col-sm-10">
     				<input type="text" name="nama" class="form-control" id="inputEmail3" placeholder="Nama Lengkap" value="<?= $data_pes['nama_peserta'] ?>">
    			  </div>
  				</div>            
				...
				<div class="form-group row">
    				...
    				<div class="col-sm-10">
						<input type="text" name="tempat_lahir" class="form-control" id="inputEmail3" placeholder="tempat_lahir" value="<?= $data_pes['tempat_lahir'] ?>">
    			  	</div>
				</div> 
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" name="tgl_lahir" class="form-control" id="tempat_lahir" placeholder="tanggal/bulan/tahun" value="<?= $data_pes['tanggal_lahir'] ?>">
					</div>
				</div>
				...
				<div class="form-check row">
					...
					<div class="col-sm-10">
                        <?php
                        if ($data_pes['jenis_kelamin'] == "Laki-laki"){ ?>
						    <input type="radio" name="jenis_kelamin" value="Laki-laki" class="form-check-input" checked>Laki-laki &nbsp;
                        ...
                        <?php 
                            ...
                            <input type="radio" name="jenis_kelamin" value="Perempuan" class="form-check-input" checked>Perempuan
                        <?php
                        }
                        ?>
                    </div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<textarea name="alamat" class="form-control" id="exampleFormControlTextarea1" rows="3"><?= $data_pes['alamat'] ?></textarea>
					</div>
  				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="email" name="email" class="form-control" placeholder="example@email.com" value="<?= $data_pes['email'] ?>">
					</div>
  				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" name="instansi" class="form-control" placeholder="Instansi" value="<?= $data_pes['instansi'] ?>">
					</div>
  				</div>
