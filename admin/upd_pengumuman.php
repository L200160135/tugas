<?php
  ...
  if(isset($_SESSION['admin'])) {
	...
	$get_id		= $_GET['id'];
	$sql_select	= "SELECT * FROM pengumuman WHERE id_pengumuman = $get_id";
	...
	if (isset($_POST['update'])){
		...
		// jika tidak memiih gambar saat upload
		if ($upload == "img/"){ $upload = $data['gambar'];}

		// update ke database tabel pengumuman
		$sql_update = "UPDATE pengumuman SET judul='$judul', subjudul='$subjudul', isi='$isi', gambar='$upload' WHERE id_pengumuman='$get_id'";
            ...
            <div class="box-body">
			  ...
			  <form method="post" enctype="multipart/form-data">
				<!-- input judul -->
    			  ...
    			  <div class="col-sm-10">
     				<input type="text" name="judul" class="form-control" id="inputEmail3" placeholder="Judul" value="<?= $data['judul'] ?>">
    			  </div>
  				</div>            
				  
				  <!-- input subjudul -->
				<div class="form-group row">
    		    	<label for="inputEmail3" class="col-sm-2 col-form-label"> Subjudul</label>
    				<div class="col-sm-10">
						<input type="text" name="subjudul" class="form-control" id="inputEmail3" placeholder="Subudul" value="<?= $data['subjudul'] ?>">
    			  	</div>
				</div> 
				
				<!-- input isi -->
				<div class="form-group row">
					<label for="exampleFormControlTextarea1" class="col-sm-2 col-form-label">Isi</label>
					<div class="col-sm-10">
						<textarea name="isi" class="form-control" id="exampleFormControlTextarea1" rows="10"><?= $data['isi'] ?>"</textarea>
					</div>
  				</div>

				<!-- input gambar -->
				<div class="form-group">
					<label for="exampleFormControlFile1" class="col-sm-2">Gambar</label>
					<div class="col-sm-10"> 
					<img src="<?= $data['gambar'] ?>" width="360">
