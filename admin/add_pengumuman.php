<?php
  ...
  if(isset($_SESSION['admin'])) {
	...
	if (isset($_POST['simpan'])){
		...
		// insert ke database tabel pengumuman
		$sql = "INSERT INTO pengumuman(judul, subjudul, isi, gambar) VALUES ('$judul', '$subjudul', '$isi', '$upload')";
            ...
            <div class="box-body">
			  ...
			  <form method="post" enctype="multipart/form-data">
				...
				<div class="form-group row">
    				...
    				<div class="col-sm-10">
						<input type="text" name="subjudul" class="form-control" id="inputEmail3" placeholder="Subudul">
    			  	</div>
				</div> 
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<textarea name="isi" class="form-control" id="exampleFormControlTextarea1" rows="10"></textarea>
					</div>
  				</div>
